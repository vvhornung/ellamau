        ...
        {Object.entries(groupedProducts).map(([baseName, variants]) =>
          variants.length === 1 ? (
            ...
            <React.Fragment key={baseName}>
              <tr className="bg-neutral-900 w-full">
                {/* make an inline style for this for a media query, if it is smaller than md size, then it will be hidden */}
                <td className="hidden md:table-cell"></td>

                {/* This cell is bellow the empty one */}
